...
public:
    ...
    void setupUi(QDialog *NewFloppyDialog)
    {
        ...
        labelFileName = new QLabel(NewFloppyDialog);
        labelFileName->setObjectName(QString::fromUtf8("labelFileName"));

        formLayout->setWidget(0, QFormLayout::LabelRole, labelFileName);
        ...
        labelSize = new QLabel(NewFloppyDialog);
    ...
    void retranslateUi(QDialog *NewFloppyDialog)
    {
        ...
        labelFileName->setText(QCoreApplication::translate("NewFloppyDialog", "File name:", nullptr));
        labelSize->setText(QCoreApplication::translate("NewFloppyDialog", "Disk size:", nullptr));
