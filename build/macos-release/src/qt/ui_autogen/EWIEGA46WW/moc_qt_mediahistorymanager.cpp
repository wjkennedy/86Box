...
QT_MOC_LITERAL(4, 28, 5), // "RDisk"
QT_MOC_LITERAL(5, 34, 2), // "Mo"
QT_MOC_LITERAL(6, 37, 8), // "Cassette"
QT_MOC_LITERAL(7, 46, 9), // "Cartridge"
QT_MOC_LITERAL(8, 56, 4) // "Tape"

    },
    "ui\0MediaType\0Floppy\0Optical\0RDisk\0Mo\0"
    "Cassette\0Cartridge\0Tape"
};
...
static const uint qt_meta_data_ui[] = {
 ...
 // enum data: key, value
       ...
       4, uint(ui::MediaType::RDisk),
       5, uint(ui::MediaType::Mo),
       6, uint(ui::MediaType::Cassette),
       7, uint(ui::MediaType::Cartridge),
       8, uint(ui::MediaType::Tape),
