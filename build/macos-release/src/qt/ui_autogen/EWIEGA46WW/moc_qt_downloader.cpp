...
QT_MOC_LITERAL(1, 11, 17), // "downloadCompleted"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "filename"
QT_MOC_LITERAL(4, 39, 7), // "varData"
QT_MOC_LITERAL(5, 47, 13), // "errorOccurred"
QT_MOC_LITERAL(6, 61, 8) // "onResult"

    },
    "Downloader\0downloadCompleted\0\0filename\0"
    "varData\0errorOccurred\0onResult"
};
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->downloadCompleted((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QVariant(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Downloader::*)(QString , QVariant );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Downloader::downloadCompleted)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Downloader::errorOccurred)) {
                *result = 1;
                return;
            }
        }
